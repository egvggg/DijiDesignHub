const tests = [
    ...
    const questionTitles = [
        'Цель паттерна "Действие-Отмена"?', 'Какая из этих ситуаций наиболее подходит для применения паттерна "Действие-Отмена"?',
        'Как паттерн "Мгновенное удовлетворение" влияет на пользовательский опыт?', 'В каком случае использование паттерна "Мгновенное удовлетворение" наиболее целесообразно?',
        'В каких типах интерфейсов использование паттерна "Сканирование" наиболее эффективно?', 'Как паттерн "Сканирование" помогает улучшить пользовательский опыт?',
        'Почему согласованность использования паттерна "Привыкание" между приложениями важна для пользователя?', 'Почему согласованность использования паттерна "Привыкание" между приложениями важна для пользователя?',
        'Что представляет собой паттерн "Социальное доказательство"?', 'В каких ситуациях применение паттерна "Социальное доказательство" будет наиболее эффективным?',
        'Как паттерн "Якорения" может влиять на восприятие цен пользователями на веб-странице?', 'Размещение каких элементов на главной странице может служить "якорем" для последующих сравнений пользователей?',
        'Какая из визуальных подсказок НЕ помогает снизить когнитивную нагрузку на пользователей?', 'Какой из перечисленных аспектов оптимизации для мобильных устройств может снизить когнитивную нагрузку?',
        'Какой из примеров наилучшим образом демонстрирует применение паттерна "Проспективная память" в веб-дизайне?', 'Какая из приведенных ситуаций наилучшим образом демонстрирует правильное применение паттерна "Управление ожиданиями"?',
        'Какой из перечисленных приемов относится к методам управления ожиданиями пользователей?', 'Что из перечисленного НЕ относится к принципам реализации паттерна "Настройка и персонализация"?',
        'Какой из перечисленных принципов НЕ относится к паттерну "Настройка и персонализация"?', 'Какая из перечисленных функций лучше всего помогает пользователям не забывать о незавершенных задачах на веб-сайте?'
