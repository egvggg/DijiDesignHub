const tests = [
    {
        question: "Брифинг. Какой вариант верный?",
        questionImage: "images/briefing1.jpg",
        images: [
            {
            ...
            },
            {
                ...
                correct: false,
                message: "Нет, вопросы не уточняют, что именно важно для клиента, это может привести к недопониманию",
                footerColor: "#FF4E51",
    ...
    {
        question: "Брифинг. Какой вариант верный?",
        questionImage: "images/briefing2.jpg",
        images: [
            {
                src: "images/badgoodux11.jpg",
                correct: false,
    ...
    {
        question: "Брифинг. Какой вариант верный?",
        questionImage: "images/briefing3.jpg",
        images: [
            {
                src: "images/badgoodux11.jpg",
                correct: false,
    ...
    {
        question: "Условия работы и стоимость услуг. Какой вариант верный?",
        questionImage: "images/workingconditions1.jpg",
        images: [
            {
                src: "images/badgoodux11.jpg",
                correct: true,
            ...
            },
            {
                src: "images/badgoodux12.jpg",
                correct: false,
                message: "Нет, дизайнер не чётко сформулировал условия работы, это может привести к недопониманию и конфликтам",
                footerColor: "#FF4E51",
                icon: "images/icon1.svg"
            }
        ]
    ...
    {
        question: "Условия работы и стоимость услуг. Какой вариант верный?",
        questionImage: "images/workingconditions2.jpg",
        images: [
            {
                src: "images/badgoodux11.jpg",
                correct: true,
                message: "Да! У дизайнера есть свой прайс-лист. Это позволяет клиенту иметь четкое представление о стоимости услуг",
                footerColor: "#4EFF84",
                icon: "images/icon.svg"
            },
            {
                src: "images/badgoodux12.jpg",
                correct: false,
                message: "Нет, у дизайнера отсутствует прайс-лист, он не может бъяснить на что клиент потратит деньги",
                footerColor: "#FF4E51",
                icon: "images/icon1.svg"
            }
        ]
    ...
    {
        question: "Заключение договора. Какой вариант верный?",
        questionImage: "images/agreement.jpg",
        images: [
            {
                src: "images/badgoodux11.jpg",
                correct: false,
                message: "Нет, дизайнер не настоял на заключении договора",
                footerColor: "#FF4E51",
                icon: "images/icon1.svg"
            },
            {
    ...
    {
        question: "Прототипирование и дизайн. Какой вариант верный?",
        questionImage: "images/agreement2.jpg",
        images: [
            {
                src: "images/badgoodux11.jpg",
                correct: true,
                message: "Да! Дизайнер ознакомил клиента с этапами прототипирования и дизайна",
                footerColor: "#4EFF84",
                icon: "images/icon.svg"
            },
            {
                src: "images/badgoodux12.jpg",
                correct: false,
                message: "Нет, дизайнер не ознакомил клиента с этапами прототипирования и дизайн",
                footerColor: "#FF4E51",
                icon: "images/icon1.svg"
            }
        ]
        ...
        function showPopup(image) {
            ...
            nextButton.onclick = () => {
                ...
                if (currentQuestionIndex < tests.length) {
                    ...
                    localStorage.setItem('test10CorrectAnswers', correctAnswers);
